...
def get_counts(dataframe):
    '''
    get counts for y_target for a column to plot
    '''
    '''
...
def create_graph(dataframe): # as of 1/3/21 mostly fixed output - but need to decide on how / which columns to display
    '''                                      
    Stacked bar chart 
    '''
...
if __name__ == '__main__':
    colz_9999 = make_cols_binary(df_9999) #, make_cols_binary(df_9999)
