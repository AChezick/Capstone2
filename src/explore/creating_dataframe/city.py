...
df2 = pd.read_csv('/home/allen/Galva/capstones/capstone2/data/ready12_24_train.csv') 
camp_info = pd.read_csv('/home/allen/Galva/capstones/capstone2/data/Health_Camp_Detail.csv')
# print(df2['City_Type2_x'][101:121])
...
df_encode = one_hot_encoding(df2, columns = ['City_Type2_x'])
print(df_encode.columns)
df_encode2 = one_hot_encoding(df_encode, columns = ['Job Type_x'])
